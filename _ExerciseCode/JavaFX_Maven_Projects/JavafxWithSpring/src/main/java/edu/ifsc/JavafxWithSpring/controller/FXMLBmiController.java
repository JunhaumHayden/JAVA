 ...
 */
package edu.ifsc.JavafxWithSpring.controller;
...
import edu.ifsc.JavafxWithSpring.model.Bmi;
 ...
 * @author hayden
 */
//Informa para o Spring que é um Service e o arquivo da view
@Service
@FxmlView("FXMLCalculoIMC.fxml")
public class FXMLBmiController implements Initializable {
    ...
    private void handleBtCalcular(ActionEvent event) {
        ...
        Bmi imc = new Bmi(nome, sexo, idade, peso, altura);
    ...
    private void apresentarResultado(Bmi imc) {
