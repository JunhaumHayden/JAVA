...
public class OrdemDeServico {
     ...
     * 
     */
    public OrdemDeServico(float desconto, Veiculo veiculo) {
        this();
...
//    }
    ...
    // Métodos
    public BigDecimal calcularServico() {
        BigDecimal totalServico = BigDecimal.ZERO; // Inicializa o total com 0
        for (ItemOS item : itens) {
            totalServico = totalServico.add(item.getValorServico()); // Adiciona o valor do serviço do item
        }
        this.total = totalServico; // Atualiza o campo total
        return this.total; // Retorna o total calculado
    }
